<%@ Page Title="" Language="C#" MasterPageFile="~/SaleSpec.Master" AutoEventWireup="true" CodeBehind="activity_event.aspx.cs" Inherits="SaleSpec.pages.report.activity_event" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            btnQuery.click(function () {
                ...
                //alert('get data here');
                $.ajax({
                    url: 'DataServicesReporting.asmx/GetActiviteEvent',
                    method: 'post',
                    beforeSend: function () {
                        $("#overlay").show();
                    },
