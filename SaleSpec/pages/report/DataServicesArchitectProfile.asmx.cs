...
namespace SaleSpec.pages.report
{
    ...
    public class DataServicesArchitectProfile : System.Web.Services.WebService
    {
        ...
        public void GetEventActivity()
        {
            ...
            SqlCommand comm = new SqlCommand("spGetDataEventActivity", conn.OpenConn());
        ...
        public void GetEventType()
        {
            ...
            SqlCommand comm = new SqlCommand("spGetDataEventType", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        {
            List<GetDataEventType> objs = new List<GetDataEventType>();
            SqlCommand comm = new SqlCommand("spGetDataEventTypeID", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        public void GetInvitation()
        {
            ...
            SqlCommand comm = new SqlCommand("spGetDataInvitation", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        public void GetAttendance()
        {
            ...
            SqlCommand comm = new SqlCommand("spGetadAttendance", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        public void GetDataYearly()
        {
            ...
            SqlCommand comm = new SqlCommand("spGetDataYearly", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand comm = new SqlCommand("spInsertRewardEvent", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand comm = new SqlCommand("spRewardEventUpdate", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        public void GetDataPreviousYear()
        {
            ...
            SqlCommand comm = new SqlCommand("sp_GetPreviousYear", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        public void GetDataLevel()
        {
            ...
            SqlCommand comm = new SqlCommand("sp_GetDataLevel", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        public void GetLevelHistory(string id)
        {
            ...
            SqlCommand comm = new SqlCommand("sp_GetLevelHistory", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        public void GetArchitectPortOwner(string id)
        {
            ...
            SqlCommand comm = new SqlCommand("sp_GetArchitectPortOwner", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand comm = new SqlCommand("spInsertHistoryLevel", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand comm = new SqlCommand("spHistoryLevelUpdate", conn.OpenConn());
            comm.CommandType = CommandType.StoredProcedure;
            comm.Parameters.AddWithValue("@id", id);
            comm.ExecuteNonQuery();
            conn.CloseConn();
