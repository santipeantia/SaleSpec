...
{
    public partial class verify_password_newprojectreport : System.Web.UI.Page
    {
        ...
        protected void varidateRequesetData(string strVerifyCode)
        {
            try
            {
                ...
                Comm = new SqlCommand("sp_varidateRequesetNewProjectReport", Conn);
        ...
        protected void exportExcelReport(string strPort, string strStart, string strEnd, string foQty, string toQty, string strSearch)
        {
            try
            {
                ...
                Comm = new SqlCommand("spNewProjectReportingWithSearch", Conn);
                Comm.CommandType = CommandType.StoredProcedure;
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    Response.Clear();
                    Response.AddHeader("content-disposition", "attachment;filename=ExportNewProjectReport_" + strPort + ".xls");
