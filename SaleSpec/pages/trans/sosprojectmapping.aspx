<%@ Page Title="" Language="C#" MasterPageFile="~/SaleSpec.Master" AutoEventWireup="true" CodeBehind="sosprojectmapping.aspx.cs" Inherits="SaleSpec.pages.trans.sosprojectmapping" %>
   ...
   <script src="https://smtpjs.com/v3/smtp.js"></script>
        ...
        <script>
            $(document).ready(function () {                
                ...
                btnJsonReport.click(function () {
                    ...
                    if (selectSaleport == 'SELECTED ALL') {
                        if (empcode == '118052' || empcode == '316010' || empcode == '506009') {
                            $.ajax({
                                url: '../report/DataServicesReporting.asmx/GetSOSProjectMapping',
                                method: 'post',
                                beforeSend: function () {
                                    $("#overlay").show();
                                },
                                ...
                                success: function (data) {
                                    ...
                                    $('#tableWeeklyReportx tbody').on('click', 'td', function (e) {
                                        ...
                                        if (rIndex != 0 & cIndex == 8 || cIndex == 24) {
                                            ...
                                            //Get update architect name by company
                                            $.ajax({
                                                url: '../report/DataServicesReporting.asmx/DataReportGetArchitect',
                                                method: 'post',
                                                data: {
                                                    id: strVal0.text()
                                                },
                                            ...
                                            $('#txtRemark').val(strVal24.text());
                                            $.ajax({
                                                url: '../report/DataServicesReporting.asmx/GetDataProjectHistory',
                                                method: 'post',
                                                data: { ProjectID: strVal7.text() },
                                                dataType: 'json',
                                                success: function (data) {
                            ...
                            success: function (data) {
                                ...
                                $('#tableWeeklyReportx tbody').on('click', 'td', function (e) {
                                    ...
                                    if (rIndex != 0 & cIndex == 8 || cIndex == 24) {
                                        ...
                                        $('#txtProjectName').val(strVal8.text());
                                        $('#txtProjectConf').val(strVal8.text());
                ...
                $("#tblRefinvoice").on('click', '.btnSelect', function () {
                    // get the current row
                ...
                btncheck.click(function () {
                    ...
                    var table = $('#tblRefinvoice').DataTable();
                    ...
                    //$.ajax({
                    //    url: '../report/DataServicesInvoiceList.asmx/GetInvoiceListSOSMapping',
                    //    data: {
                    //        sdate: datesos
                    //    },
                    //    method: 'post',
                    //    beforeSend: function () {
                    //        $('#tblRefinvoice tr td').remove();
                    //        $("#loademployee").show();
                    //    },
                    //    dataType: 'json',
                    //    success: function (data) {
            ...
            function getDataInvoiceList() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        table.column(12).nodes().to$().addClass('textRight');
                        table.column(13).nodes().to$().addClass('textRight');
                        table.column(14).nodes().to$().addClass('textRight');
                        table.draw();
                        // $('#tblRefinvoice td:nth-of-type(12)').addClass('textRight');
                        //$('#tblRefinvoice td:nth-of-type(13)').addClass('textRight');
                        //$('#tblRefinvoice td:nth-of-type(14)').addClass('textRight');
    ...
    <section class="content">
                                ...
                                <div class="tab-content">
                                    <div class="active tab-pane" id="overview">
                                        ...
                                        <div class="post clearfix">
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                                <div class="col-md-4 txtLabel">Project Confirm</div>
                                                <div class="col-md-8">                                                   
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtProjectConf" name="txtProjectConf"  autocomplete="off" placeholder="" value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-top: 5px;">
                                             ...
                                             <div class="row" style="margin-top: 5px;">
                                                <div class="col-md-4 " >
                                                    <label class="txtLabel">SOS Date/Ref#Inv.</label>
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control input-sm pull-left txtLabel" id="datesos" name="datepickertrans" value="" autocomplete="off">
                                                        <div class="input-group-addon input-sm">
                                                            <i class="fa fa-calendar"></i>
                                                        </div>
                                                    </div>
            ...
            <div class="modal-dialog" style="width: 90%">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="post">
                            <div >
                            <table id="tblRefinvoice" class="table table-striped table-bordered table-hover table-condensed txtLabel" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th class="hidden">ID</th>
                                        <th>DocuNo</th>
        ...
        <script>
            function ValidateUpdate() {
                ...
                var str20 = document.getElementById("txtProjectConf").value;
